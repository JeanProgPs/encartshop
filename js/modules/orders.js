...
const OrderModule = (() => {
  // Fluxo de status: representa o estado OPERACIONAL do pedido (controlado pelo lojista).
  // O estado FINANCEIRO (pago, estornado, expirado) fica exclusivamente em order_payments.
  // Os dois domínios são independentes e consultados separadamente no painel.
  const STATUS_FLOW = {
